...
// Licensed under the MIT License. Copyright (c) 2019 Vuk Jovanovic.
...
{
    /// <summary>
    /// An absolute pointer. The size is determined by whether this is a 32-bit or 64-bit address space, and will be 32 or 64
    /// bits.
    /// </summary>
    AbsolutePointer = 0,

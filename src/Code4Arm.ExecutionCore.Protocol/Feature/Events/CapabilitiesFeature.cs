...
namespace Code4Arm.ExecutionCore.Protocol
{
    namespace Models
    {
        ...
        public record Capabilities
        {
            ...
            /// <summary>
            /// The debug adapter supports the 'restart' request. In this case a client should not implement 'restart' by terminating
            /// and relaunching the adapter but by calling the
            /// RestartRequest.
            /// </summary>
            [Optional]
            ...
            /// 'levels' arguments and the 'totalFrames' result of the

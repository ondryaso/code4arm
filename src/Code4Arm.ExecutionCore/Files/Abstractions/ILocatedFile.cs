...
/// presume that a <see cref="IAsmFile"/> representation is saved in the filesystem, at the path given by <see cref="FileSystemPath"/>.
/// When finished working with it, the <see cref="ILocatedFile"/> instance should be disposed which provides way of cleaning
